            ...
            >
              ...
              <List divided verticalAlign="middle">
                <List.Item style={listItemStyle}>
                  ...
                  <List.Content>{this.props.name}</List.Content>
                </List.Item>
                <List.Item style={listItemStyle}>
                ...
                <List.Item style={listItemStyle}>
                  ...
                  <List.Content
                    style={{ fontFamily: "Cormorant", fontSize: 16 }}
                  >
                    {this.props.phone}
                  </List.Content>
                </List.Item>
            ...
            <Fade bottom>
              ...
              >
                ...
                <List divided verticalAlign="middle">
                  <List.Item style={listItemStyle}>
                    <Icon size="big" name="user circle" />
                    <List.Content>{this.props.recipientName}</List.Content>
                  </List.Item>
                  <List.Item style={listItemStyle}>
                    <Icon size="big" name="call" />
                    <List.Content
            ...
            >
              ...
              <List divided verticalAlign="middle">
                <List.Item style={listItemStyle}>
                  ...
                  <List.Content>{this.props.comments}</List.Content>
                </List.Item>
              </List>
            </div>
          </Fade>
