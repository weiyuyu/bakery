...
import logo from "./../img/肉桂捲/IMG_0841.JPG";
      ...
      <Container fluid>
              ...
              <div style={{ textAlign: "center" }}>
                <div style={{ display: "inline-block", textAlign: "left" }}>
                  <h2 style={{ fontFamily: "cwTexMing", fontSize: 20 }}>
                    ...
                    <br /> 成立於
                    <span style={{ fontFamily: "Cormorant" }}>2018</span>年
                  </h2>
        ...
        <Container text style={{ marginTop: 100, marginBottom: 100 }}>
          <Header
            size="medium"
            as="a"
            href="mailto:janetsbakerytw@gmail.com"
            style={{ fontWeight: 400, fontFamily: "Cormorant", fontSize: 15 }}
          >
            {" "}
            Contact Us{" "}
          </Header>
