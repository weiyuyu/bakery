    ...
    return (
      <Animated animationIn="bounceInUp" isVisible={true}>
        ...
        <TransitionablePortal open={modalOpen}  transition={{ animation:'scale', duration: 300 }}>
          ...
          >
            <Modal.Header>
              <span style={{'margin': 3, 'fontFamily': 'cwTexMing', 'fontWeight': 400, 'fontSize': 20}}> {this.props.itemName} </span> <br/>
              <span style={{'margin': 3, 'fontFamily': 'Cormorant', 'fontWeight': 400, 'fontSize': 16}}> {this.props.itemNameEnglish} </span>
            </Modal.Header>
